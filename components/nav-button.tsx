...
export const NavButton: FC<NavButtonProps> = ({path, color, value}) => {
  const colorVariants = {
    ...
    green: "bg-green-300 hover:bg-green-400 focus:ring-green-500 text-green-900",
    red: "bg-red-300 hover:bg-red-400 focus:ring-red-500 text-red-900", 
    orange: "bg-orange-300 hover:bg-orange-400 focus:ring-orange-500 text-orange-900" 
  }
